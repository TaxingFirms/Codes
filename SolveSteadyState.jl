...
# wguess=0.54; VFItol =10.0^-3.0; VFIfunction=firmVFIParallelOmega!; distr_routine = stationarydist; maxroutine=maximizationstep; displayit0=true; displayw=true; displayitt=false; firmvalueguess = repmat(pa.omega.grid,1,pa.Nz);
