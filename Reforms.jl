...
function Reform5Vector(filename::ASCIIString, taxvector::Array, pr::FirmProblem, eq::Equilibrium, tau::Taxes, pa::Param; bctol::Float64=5.0*10.0^-3.0, update::Float64=0.9)
    ...
    println(@sprintf("%9.4f \t %9.4f \t %9.4f \t %9.4f \t %9.4f  \t %9.7f \t %9.4f \t %9.5f \t %9.4f ", eq.a.collections.d/rtau.d, eq.a.collections.l, eq.a.consumption, eq.E, eq.w, eq.a.welfare , eq.a.output/(eq.a.capital^pa.alphak*eq.a.laborsupply^pa.alphal)))
