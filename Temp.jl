...
function aggregates(res::ResultsFP, pr::FirmProblem, p::Equilibrium, tau::Taxes, hp::HouseholdParam, fp::FirmParam)
  ...
  p.m = Moments(mean_inv_rate, var_inv_rate, mean_leverage, var_leverage, mean_dividends2k, var_dividends2k, mean_profits2k, var_profits2k, mean_eqis2k, freq_equis2k, mean_tobinsq, cov_nw)
  ##############################



  ######## Save values #########
  netdistributions = netdistributions;
  agginterests = (1-tau.i)*p.r*debt;
 ...
 p.a=Aggregates(netdistributions, agginterests, consumption, output, laborsupply, welfare, collections::Taxes
 bonds, capital, investment, grossdividends, financialcosts, G);
