...
ref1 = Reform1Vector("reform1Miracle.jld", taucvec, pr, eq, tau, pa; bctol= 5*10.0^-3.0, update=0.75);
ref2 = Reform2Vector("reform2Miracle.jld", taucvec, pr, eq, tau, pa; bctol= 5*10.0^-4.0, update=0.75);
ref3 = Reform3Vector("reform3Miracle.jld", taucvec, pr, eq, tau, pa; bctol= 5*10.0^-4.0, update=0.75);
