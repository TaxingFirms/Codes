...
ref2 = Reform2Vector("reform2.jld", taucvec, pr, eq, tau, pa; bctol= 5.0*10.0^-3.0, update=0.75);
ref3 = Reform3Vector("reform3.jld", taucvec, pr, eq, tau, pa; bctol= 5.0*10.0^-3.0, update=0.75);

tauivec = [0.27 0.25 0.23 0.21 0.19 0.17 0.15 0.13 0.11 0.09 0.07 0.05 0.03 0.01 0.00 ];
re2taui = Reform2TauIVector("Reform2TauIVector.jld", tauivec, pr, eq, tau, pa; bctol= 5.0*10.0^-3.0, update=0.75);
...
taucvec =  [0.33 0.31 0.29 0.27 0.25 0.23 0.21 0.19 0.17 0.15 ];
ref1 = Reform1Vector("reform1.jld", taucvec, prg, eqg, taug, pag; bctol= 5.0*10.0^-3.0, update=0.75);

taucvec = [0.33 0.31 0.29 0.27 0.25 0.23 0.21 0.19 0.17 0.15 0.13 0.11 0.09 0.07 0.05 0.03 0.01 0.00];
ref5 = Reform5Vector("reform5.jld", taucvec, prg, eqg, taug, pag; bctol= 5.0*10.0^-3.0, update=0.75);
ref6 = Reform6Vector("reform6.jld", taucvec, prg, eqg, taug, pag; bctol= 5.0*10.0^-3.0, update=0.75);
